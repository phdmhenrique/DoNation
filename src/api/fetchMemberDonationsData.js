export const fetchMemberDonationsData = (username) => {
    ...
    donations: [
      {
        ...
        donationDescription:
          "We offer tutoring classes for elementary school children, focusing on math and language skills to support their studies and improve academic performance.",
      ...
      },
      {
        ...
        donationDescription:
          "We offer free English classes for children in the community. The classes are interactive and aim to improve communication skills in a fun and engaging way.",
      ...
      },
      {
        ...
        donationDescription:
          "We distribute basic food baskets containing essential items like rice, beans, oil, sugar, among others, to families in need.",
      ...
      // Completed donations
      {
        ...
        donationDescription:
          "We distribute used clothing in good condition to families in need. The items are selected and cleaned before delivery, ensuring quality and comfort for recipients.",
      ...
      },
      {
        ...
        donationDescription:
          "We hold bicycle repair workshops for the community, helping maintain bicycles in good condition and promoting sustainable transportation.",
      ...
      },
      {
        ...
        donationDescription:
          "We organize park and public square cleaning initiatives, aiming to improve community spaces and encourage civic participation.",
      ...
      // Canceled donations
      {
        ...
        donationDescription:
          "We distribute personal hygiene kits containing items like soap, toothpaste, toothbrush, and hand sanitizer to people in need.",
  ...
  const filteredDonations = member.donations.filter(
    (donation) => member.memberUsername === username
  );
